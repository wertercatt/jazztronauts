...
if __name__ == "__main__":
    ...
    while True:
        req = "{}/{}?key={}&appid={}&requiredtags[0]=map&numperpage={}&page={}&return_metadata=1&query_type=1".format(
            HOST, ENDPOINT, key, APPID, NUMPERPAGE, page
        )
        ...
        print(
            "Finished {} addons. ({:.2f}% of {})".format(
                finished, finished * 100.0 / total, total
            )
        )
    ...
    print(f"Dumping {len(workshopids)} addons to {FILENAME}")
